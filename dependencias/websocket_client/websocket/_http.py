...
def _wrap_sni_socket(sock, sslopt, hostname, check_hostname):
    ...
    if not context:
        ...
        # Contextos não padrão precisam habilitar manualmente o suporte a SSLKEYLOGFILE definindo o atributo keylog_filename.
        ...
        # Python 3.10 muda para PROTOCOL_TLS_CLIENT com padrões para "cert_reqs = ssl.CERT_REQUIRED" e "check_hostname = True"
        # Se ambos desativados, defina check_hostname antes de verify_mode
        # veja https://github.com/liris/websocket-client/commit/b96a2e8fa765753e82eea531adb19716b52ca3ca#commitcomment-10803153
